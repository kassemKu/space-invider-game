...
function animate() {
  ...
  particles.forEach((particle, i) => {
    ...
    if (particle.position.y - particle.radius >= canvas.height) {
      particle.position.y = Math.random() * canvas.width;
  ...
  invaderProjectiles.forEach((invaderProjectile, index) => {
    ...
    if (invaderProjectile.position.y + invaderProjectile.height >= player.position.y && invaderProjectile.position.x + invaderProjectile.height >= player.position.x && invaderProjectile.position.x <= player.position.x + player.width) {
      setTimeout(() => {
